...
import saveUpdatePresentation from './presentationUpdate';
...
function PresentationEdit () {
  ...
  // };
  let nextId = 1;
  if (presentationState && presentationState[slideNumber]) {
      nextId = Object.values(presentationState[slideNumber]).length+1;
  }
  ...
  let intObjects;
  if (presentationState && presentationState[slideNumber]) {
      intObjects = Object.values(presentationState[slideNumber]);
  }
  return presentationState && presentationState[slideNumber] && (
    <>
